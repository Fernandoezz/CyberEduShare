      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-14 bg-white border-b border-gray-100 flex items-center gap-4 px-6 flex-shrink-0">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <span className="text-sm font-medium text-gray-700">{user?.username ?? 'Moderator'}</span>
          </div>
          ...
          <div className="flex-1 flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 bg-indigo-600 text-white text-sm px-4 py-1.5 rounded-full hover:bg-indigo-700 transition-colors"
            >
              All
